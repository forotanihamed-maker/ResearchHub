        ...
        <main>
          <section className="max-w-5xl mx-auto px-6 sm:px-8 py-20 sm:py-24 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              پژوهش دانشگاهی را
              <span className="text-indigo-400"> منظم‌تر </span>
              و
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-7 sm:p-8">
                ...
                <div className="space-y-4 text-sm sm:text-base text-slate-400 leading-7">
                  <p>
                    در بسیاری از محیط‌های دانشگاهی، معرفی پروژه‌های پژوهشی،
                    پیدا کردن دانشجوی مناسب و پیگیری درخواست‌ها در ابزارهای
                    مختلف انجام می‌شود.
                  </p>

                  <p>
                    دانشجو ممکن است از فرصت‌های پژوهشی موجود اطلاع نداشته باشد
                    و استاد نیز برای پیدا کردن دانشجوی علاقه‌مند و مدیریت
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-950/30 p-7 sm:p-10">
              <div className="max-w-2xl mb-10">
                ...
                <p className="text-slate-400 leading-7">
                  سامانه برای نقش‌های مختلف دانشگاه طراحی شده و هر کاربر
                  متناسب با نقش خود به امکانات مربوط دسترسی دارد.
                </p>
              </div>
